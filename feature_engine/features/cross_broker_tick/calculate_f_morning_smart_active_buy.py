...
@register_feature
class FMorningSmartActiveBuy(BaseFeature):
    name = "f_morning_smart_active_buy"
    description = "Profile feature: f_morning_smart_active_buy"
    required_columns = ["StockId", "Date", "f_morning_smart_active_buy"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        out_series = all_features["f_morning_smart_active_buy"]
