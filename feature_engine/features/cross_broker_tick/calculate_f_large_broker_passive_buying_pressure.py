...
@register_feature
class FLargeBrokerPassiveBuyingPressure(BaseFeature):
    name = "f_large_broker_passive_buying_pressure"
    description = "Profile feature: f_large_broker_passive_buying_pressure"
    required_columns = ["StockId", "Date", "f_large_broker_passive_buying_pressure"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        out_series = all_features["f_large_broker_passive_buying_pressure"]
