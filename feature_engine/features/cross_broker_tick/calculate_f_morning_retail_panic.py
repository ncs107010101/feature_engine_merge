...
@register_feature
class FMorningRetailPanic(BaseFeature):
    name = "f_morning_retail_panic"
    description = "Profile feature: f_morning_retail_panic"
    required_columns = ["StockId", "Date", "f_morning_retail_panic"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        out_series = all_features["f_morning_retail_panic"]
