...
@register_feature
class FLargeBrokerActiveBuy(BaseFeature):
    name = "f_large_broker_active_buy"
    description = "Profile feature: f_large_broker_active_buy"
    required_columns = ["StockId", "Date", "f_large_broker_active_buy"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        out_series = all_features["f_large_broker_active_buy"]
