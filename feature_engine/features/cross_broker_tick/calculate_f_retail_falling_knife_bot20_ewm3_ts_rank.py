...
@register_feature
class FRetailFallingKnifeBot20Ewm3TsRank(BaseFeature):
    name = "f_retail_falling_knife_bot20_ewm3_ts_rank"
    description = "Profile feature: f_retail_falling_knife_bot20_ewm3_ts_rank"
    required_columns = ["StockId", "Date", "r_retail_falling_knife_bot20"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        ewm = all_features.groupby(level="StockId")["r_retail_falling_knife_bot20"].transform(lambda x: x.ewm(span=3).mean())
