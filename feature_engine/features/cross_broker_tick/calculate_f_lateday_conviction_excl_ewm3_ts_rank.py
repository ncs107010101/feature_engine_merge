...
@register_feature
class FLatedayConvictionExclEwm3TsRank(BaseFeature):
    name = "f_lateday_conviction_excl_ewm3_ts_rank"
    description = "Profile feature: f_lateday_conviction_excl_ewm3_ts_rank"
    required_columns = ["StockId", "Date", "r_lateday_conviction_excl"]
    ...
    def calculate(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        ewm = all_features.groupby(level="StockId")["r_lateday_conviction_excl"].transform(lambda x: x.ewm(span=3).mean())
